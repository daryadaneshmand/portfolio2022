...
// NEW SLIDESHOW TYPE - W DOTS & ARROWS
...
function togglePiece(piece) {
	var desc = document.getElementById(piece + '-desc');
	var pieceElement = document.querySelector('.' + piece);
	desc.classList.toggle('hidden');
	pieceElement.classList.toggle('expanded');
  }
